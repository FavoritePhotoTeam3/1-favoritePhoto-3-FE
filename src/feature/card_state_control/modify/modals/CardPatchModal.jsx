...
import style from "./CardPatchModal.module.css";
...
import CardPatchButton from "./components/CardPatchButton";

export const CardPathModal = ({ dataId, onClickClose }) => {
  const myCards = useSelector((state) =>
    state.mySaleCard.myCards.find((item) => item.id === parseInt(dataId))
  );
          ...
          <section className={style.hopeExchangeContainer}>
            ...
            <section className={style.outAreaSection}>
              ...
              <div className={style.btnContainer}>
                ...
                <CardPatchButton cardId={cardId} closeModal={onClickClose} />
              </div>
            </section>
          </section>
        </section>
