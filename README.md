...
- Modal
  ...
  - 마이 갤러리 조회 모달
    - 마켓 플레이스에서 모달 창으로 마이 갤러리를 조회할 수 있는 모달 구현
    - 모달 내에서 카드를 선택하면 판매 등록 모달로 업데이트
  - 판매 등록 모달
    - 모달 내에서 판매 등록 갯수, 교환 희망 정보를 기입하고 마켓 플레이스에 등록할 수 있는 모달 구현
...
- 페이지
  ...
  - 마이갤러리 포토 상세
    - 사용자가 보유한 카드의 상세 정보를 확인하고 마켓에 등록할 수 있는 페이지 구현
